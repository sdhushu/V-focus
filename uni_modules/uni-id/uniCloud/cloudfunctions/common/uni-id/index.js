...
const V = uniCloud.database(),
	...
	H = V.collection("uni-id-permissions"),
	$ = {
		username: "username",
		mobile: "mobile",
		email: "email",
...
class te {
	...
	async _requestWxOpenapi({
		...
		return await Z({
			name: "auth." + e,
			url: `${this.options.baseUrl}${ee(t,r)}`,
			data: r,
			options: n,
			defaultOptions: i
		})
...
class se extends class {
	...
	_getSign(e, t) {
		...
		const s = C(i),
			...
			c = n.createSign(ie[this.options.signType]).update(a, "utf8").sign(this.options.privateKey, "base64");
	...
	_checkResponseSign(e, t) {
		...
		const r = this._getSignStr(e, t),
			i = JSON.parse(e).sign,
			o = n.createVerify(ie[this.options.signType]);
...
function ue(e) {
	if (e <= 127) return ce(e);
	var t = ce(e);
	return ce(128 + t.length / 2) + t
}
...
var le = de((function(e, t) {
	...
	pe = (le.Buffer, le.Buffer);

function fe(e) {
	if (this.buffer = null, this.writable = !0, this.readable = !0, !e) return this.buffer = pe.alloc(0), this;
	if ("function" == typeof e.pipe) return this.buffer = pe.alloc(0), e.pipe(this), this;
...
s.inherits(fe, o), fe.prototype.write = function(e) {
	this.buffer = pe.concat([this.buffer, pe.from(e)]), this.emit("data", e)
...
function we(e, t) {
	if (!he.isBuffer(e) || !he.isBuffer(t)) return !1;
	if (e.length !== t.length) return !1;
	for (var r = 0, n = 0; n < e.length; n++) r |= e[n] ^ t[n];
	return 0 === r
}
we.install = function() {
	he.prototype.equal = ge.prototype.equal = function(e) {
		return we(this, e)
	}
};
var ve = he.prototype.equal,
	_e = ge.prototype.equal;

function be(e) {
	return (e / 8 | 0) + (e % 8 == 0 ? 0 : 1)
}
we.restore = function() {
	he.prototype.equal = ve, ge.prototype.equal = _e
};
var Ee = {
	ES256: be(256),
	ES384: be(384),
...
var Se = {
	...
	Ie = le.Buffer,
	ke = "secret must be a string or buffer",
	Oe = "key must be a string or a buffer",
	Re = "function" == typeof n.createPublicKey;

function Pe(e) {
	if (!Ie.isBuffer(e) && "string" != typeof e) {
		if (!Re) throw Ne(Oe);
		if ("object" != typeof e) throw Ne(Oe);
		if ("string" != typeof e.type) throw Ne(Oe);
		if ("string" != typeof e.asymmetricKeyType) throw Ne(Oe);
		if ("function" != typeof e.export) throw Ne(Oe)
	}
}

function De(e) {
	if (!Ie.isBuffer(e) && "string" != typeof e && "object" != typeof e) throw Ne(
	...
	return function(t, r) {
		! function(e) {
			if (!Ie.isBuffer(e)) {
				...
				if (!Re) throw Ne(ke);
				if ("object" != typeof e) throw Ne(ke);
				if ("secret" !== e.type) throw Ne(ke);
				if ("function" != typeof e.export) throw Ne(ke)
			}
		}(r), t = Le(t);
		var i = n.createHmac("sha" + e, r);
		return je((i.update(t), i.digest("base64")))
	}
}
...
function Me(e) {
	return function(t, r) {
		...
		return je((i.update(t), i.sign(r, "base64")))
	}
}
...
function Ke(e) {
	...
	return function(r, n, i) {
		return n = Se.joseToDer(n, "ES" + e).toString("base64"), t(r, n, i)
	}
}
...
Re && (Oe += " or a KeyObject", ke += "or a KeyObject");
var Ye = function(e) {
		var t = {
				hs: Ue,
				rs: Me,
	...
	ze = i.Buffer,
	Je = function(e) {
		return "string" == typeof e ? e : "number" == typeof e || ze.isBuffer(e) ? e.toString() : JSON.stringify(e)
	},
	Xe = le.Buffer;

function We(e, t) {
	return Xe.from(e, t).toString("base64").replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_")
}
...
function et(e) {
	...
	this.readable = !0, this.header = e.header, this.encoding = e.encoding, this.secret = this.privateKey = this.key =
		r, this.payload = new me(e.payload), this.secret.once("close", function() {
			!this.payload.writable && this.readable && this.sign()
		}.bind(this)), this.payload.once("close", function() {
			!this.secret.writable && this.readable && this.sign()
		}.bind(this))
}
s.inherits(et, o), et.prototype.sign = function() {
	try {
		var e = Ze({
			header: this.header,
...
var tt = et,
	rt = le.Buffer,
	nt = /^[a-zA-Z0-9\-_]+?\.[a-zA-Z0-9\-_]+?\.([a-zA-Z0-9\-_]+)?$/;
...
function ot(e) {
	var t = e.split(".", 1)[0];
	return it(rt.from(t, "base64").toString("binary"))
}
...
function ct(e, t, r) {
	...
	return Ye(t).verify(o, i, r)
}

function ut(e, t) {
	if (t = t || {}, !at(e = Je(e))) return null;
	var r = ot(e);
	if (!r) return null;
	var n = function(e, t) {
		t = t || "utf8";
		var r = e.split(".")[1];
		return rt.from(r, "base64").toString(t)
	}(e);
...
function dt(e) {
	...
	this.readable = !0, this.algorithm = e.algorithm, this.encoding = e.encoding, this.secret = this.publicKey = this
		.key = r, this.signature = new me(e.signature), this.secret.once("close", function() {
			!this.signature.writable && this.readable && this.verify()
		}.bind(this)), this.signature.once("close", function() {
			!this.secret.writable && this.readable && this.verify()
		}.bind(this))
}
s.inherits(dt, o), dt.prototype.verify = function() {
	try {
		var e = ct(this.signature.buffer, this.algorithm, this.key.buffer),
			t = ut(this.signature.buffer, this.encoding);
		return this.emit("done", e, t), this.emit("data", e), this.emit("end"), this.readable = !1, e
	} catch (e) {
		this.readable = !1, this.emit("error", e), this.emit("close")
	}
}, dt.decode = ut, dt.isValid = at, dt.verify = ct;
var lt = dt,
	pt = {
...
var ht = mt,
	gt = function(e, t) {
		ht.call(this, e), this.name = "NotBeforeError", this.date = t
	};
(gt.prototype = Object.create(ht.prototype)).constructor = gt;
var yt = gt,
	wt = function(e, t) {
		ht.call(this, e), this.name = "TokenExpiredError", this.expiredAt = t
	};
(wt.prototype = Object.create(ht.prototype)).constructor = wt;
var vt = wt,
	_t = 1e3,
	bt = 60 * _t,
	Et = 60 * bt,
	...
	Tt = function(e, t) {
		...
		if ("number" === r && isFinite(e)) return t.long ? function(e) {
			var t = Math.abs(e);
			if (t >= Ct) return At(e, t, Ct, "day");
			if (t >= Et) return At(e, t, Et, "hour");
			if (t >= bt) return At(e, t, bt, "minute");
			if (t >= _t) return At(e, t, _t, "second");
			return e + " ms"
		}(e) : function(e) {
			var t = Math.abs(e);
			if (t >= Ct) return Math.round(e / Ct) + "d";
			if (t >= Et) return Math.round(e / Et) + "h";
			if (t >= bt) return Math.round(e / bt) + "m";
			if (t >= _t) return Math.round(e / _t) + "s";
			return e + "ms"
		}(e);
...
var xt = function(e, t) {
	...
	St = de((function(e, t) {
		...
		var H = s++;
		o[H] = "(<|>)?=?\\s*\\*";
		for (var $ = 0; $ < 35; $++) r($, o[$]), i[$] || (i[$] = new RegExp(o[$]));
	...
	It = (St.SEMVER_SPEC_VERSION, St.re, St.src, St.parse, St.valid, St.clean, St.SemVer, St.inc, St.diff, St
		.compareIdentifiers, St.rcompareIdentifiers, St.major, St.minor, St.patch, St.compare, St.compareLoose, St
		.rcompare, St.sort, St.rsort, St.gt, St.lt, St.eq, St.neq, St.gte, St.lte, St.cmp, St.Comparator, St.Range, St
		.toComparators, St.satisfies, St.maxSatisfying, St.minSatisfying, St.minVersion, St.validRange, St.ltr, St.gtr,
		St.outside, St.prerelease, St.intersects, St.coerce, St.satisfies(process.version, "^6.12.0 || >=8.0.0")),
	kt = ["RS256", "RS384", "RS512", "ES256", "ES384", "ES512"],
	Ot = ["RS256", "RS384", "RS512"],
	Rt = ["HS256", "HS384", "HS512"];
It && (kt.splice(3, 0, "PS256", "PS384", "PS512"), Ot.splice(3, 0, "PS256", "PS384", "PS512"));
var Pt = /^\s+|\s+$/g,
	Dt = /^[-+]0x[0-9a-f]+$/i,
	jt = /^0b[01]+$/i,
	qt = /^0o[0-7]+$/i,
...
var Mt, Bt, Ft = Object.prototype,
	Ht = Ft.hasOwnProperty,
	$t = Ft.toString,
	Kt = Ft.propertyIsEnumerable,
	Gt = (Mt = Object.keys, Bt = Object, function(e) {
		return Mt(Bt(e))
	}),
	Qt = Math.max;

function Yt(e, t) {
	var r = Xt(e) || function(e) {
			return function(e) {
				return er(e) && Wt(e)
			}(e) && Ht.call(e, "callee") && (!Kt.call(e, "callee") || "[object Arguments]" == $t.call(e))
		}(e) ? function(e, t) {
		...
		n = r.length,
		i = !!n;
	for (var o in e) !t && !Ht.call(e, o) || i && ("length" == o || Jt(o, n)) || r.push(o);
	return r
}

function zt(e) {
	if (r = (t = e) && t.constructor, n = "function" == typeof r && r.prototype || Ft, t !== n) return Gt(e);
	var t, r, n, i = [];
	for (var o in Object(e)) Ht.call(e, o) && "constructor" != o && i.push(o);
	return i
}

function Jt(e, t) {
	return !!(t = null == t ? 9007199254740991 : t) && ("number" == typeof e || Nt.test(e)) && e > -1 && e % 1 == 0 &&
		e < t
}
...
var tr = function(e, t, r, n) {
		var i;
		e = Wt(e) ? e : (i = e) ? Vt(i, function(e) {
			return Wt(e) ? Yt(e) : zt(e)
		}(i)) : [], r = r && !n ? function(e) {
			var t = function(e) {
					if (!e) return 0 === e ? e : 0;
					if ((e = function(e) {
							...
							if (function(e) {
									return "symbol" == typeof e || er(e) && "[object Symbol]" == $t.call(e)
								}(e)) return NaN;
							if (Zt(e)) {
							...
							e = e.replace(Pt, "");
							var r = jt.test(e);
							return r || qt.test(e) ? Lt(e.slice(2), r ? 2 : 8) : Dt.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
		...
		return r < 0 && (r = Qt(o + r, 0)),
			function(e) {
				return "string" == typeof e || !Xt(e) && er(e) && "[object String]" == $t.call(e)
		...
		return "number" == typeof e && e == function(e) {
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(ir, "");
							var r = sr.test(e);
							return r || ar.test(e) ? cr(e.slice(2), r ? 2 : 8) : or.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
						return 17976931348623157e292 * (e < 0 ? -1 : 1)
					}
					return e == e ? e : 0
...
var fr = function(e) {
	return "number" == typeof e || function(e) {
		return !!e && "object" == typeof e
	}(e) && "[object Number]" == pr.call(e)
};
var mr = Function.prototype,
	hr = Object.prototype,
	gr = mr.toString,
	yr = hr.hasOwnProperty,
	wr = gr.call(Object),
	vr = hr.toString,
	_r = function(e, t) {
		return function(r) {
...
var br = function(e) {
		if (! function(e) {
				return !!e && "object" == typeof e
			}(e) || "[object Object]" != vr.call(e) || function(e) {
				var t = !1;
		...
		return "function" == typeof r && r instanceof r && gr.call(r) == wr
	},
	Er = Object.prototype.toString,
	Cr = Array.isArray;
var Tr = function(e) {
		return "string" == typeof e || !Cr(e) && function(e) {
			return !!e && "object" == typeof e
	...
	return e = function(e) {
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(Ar, "");
							var r = Sr.test(e);
							return r || Ir.test(e) ? kr(e.slice(2), r ? 2 : 8) : xr.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
						return 17976931348623157e292 * (e < 0 ? -1 : 1)
					}
					return e == e ? e : 0
...
var Dr = function(e) {
	...
	jr = ["RS256", "RS384", "RS512", "ES256", "ES384", "ES512", "HS256", "HS384", "HS512", "none"];
It && jr.splice(3, 0, "PS256", "PS384", "PS512");
var qr = {
		expiresIn: {
			isValid: function(e) {
				return lr(e) || Tr(e) && e
...
function Lr(e, t, r, n) {
	if (!br(r)) throw new Error('Expected "' + n + '" to be a plain object.');
...
var Ur = {
	...
	Vr = ["expiresIn", "notBefore", "noTimestamp", "audience", "issuer", "subject", "jwtid"],
	Mr = function(e, t, r, n) {
		var i;
		if ("function" != typeof r || n || (n = r, r = {}), r || (r = {}), r = Object.assign({}, r), i = n || function(
				...
				if (e) throw e;
				return t
			}, r.clockTimestamp && "number" != typeof r.clockTimestamp) return i(new ht(
			"clockTimestamp must be a number"));
		if (void 0 !== r.nonce && ("string" != typeof r.nonce || "" === r.nonce.trim())) return i(new ht(
			"nonce must be a non-empty string"));
		var o = r.clockTimestamp || Math.floor(Date.now() / 1e3);
		if (!e) return i(new ht("jwt must be provided"));
		if ("string" != typeof e) return i(new ht("jwt must be a string"));
		var s, a = e.split(".");
		if (3 !== a.length) return i(new ht("jwt malformed"));
		try {
			s = ft(e, {
				complete: !0
			})
		...
		if (!s) return i(new ht("invalid token"));
		var c, u = s.header;
		if ("function" == typeof t) {
			if (!n) return i(new ht(
		...
		return c(u, (function(t, n) {
			if (t) return i(new ht("error in secret or public key callback: " + t.message));
			var c, d = "" !== a[2].trim();
			if (!d && n) return i(new ht("jwt signature is required"));
			if (d && !n) return i(new ht("secret or public key must be provided"));
			if (d || r.algorithms || (r.algorithms = ["none"]), r.algorithms || (r.algorithms = ~n
					...
					kt : ~n.toString().indexOf("BEGIN RSA PUBLIC KEY") ? Ot : Rt), !~r.algorithms.indexOf(s
					.header.alg)) return i(new ht("invalid algorithm"));
			try {
				c = pt.verify(e, s.header.alg, n)
			} catch (e) {
				return i(e)
			}
			if (!c) return i(new ht("invalid signature"));
			var l = s.payload;
			if (void 0 !== l.nbf && !r.ignoreNotBefore) {
				if ("number" != typeof l.nbf) return i(new ht("invalid nbf value"));
				if (l.nbf > o + (r.clockTolerance || 0)) return i(new yt("jwt not active", new Date(1e3 * l
					.nbf)))
			}
			if (void 0 !== l.exp && !r.ignoreExpiration) {
				if ("number" != typeof l.exp) return i(new ht("invalid exp value"));
				if (o >= l.exp + (r.clockTolerance || 0)) return i(new vt("jwt expired", new Date(1e3 * l
					.exp)))
			}
			if (r.audience) {
				...
				if (!(Array.isArray(l.aud) ? l.aud : [l.aud]).some((function(e) {
					...
					}))) return i(new ht("jwt audience invalid. expected: " + p.join(" or ")))
			}
			if (r.issuer && ("string" == typeof r.issuer && l.iss !== r.issuer || Array.isArray(r.issuer) &&
					-1 === r.issuer.indexOf(l.iss))) return i(new ht("jwt issuer invalid. expected: " + r
				.issuer));
			if (r.subject && l.sub !== r.subject) return i(new ht("jwt subject invalid. expected: " + r
				.subject));
			if (r.jwtid && l.jti !== r.jwtid) return i(new ht("jwt jwtid invalid. expected: " + r.jwtid));
			if (r.nonce && l.nonce !== r.nonce) return i(new ht("jwt nonce invalid. expected: " + r.nonce));
			if (r.maxAge) {
				if ("number" != typeof l.iat) return i(new ht("iat required when maxAge is specified"));
				var f = xt(r.maxAge, l.iat);
				if (void 0 === f) return i(new ht(
					'"maxAge" should be a number of seconds or string representing a timespan eg: "1d", "20h", 60'
					));
				if (o >= f + (r.clockTolerance || 0)) return i(new vt("maxAge exceeded", new Date(1e3 * f)))
			}
			if (!0 === r.complete) {
				var m = s.signature;
				return i(null, {
	...
	Br = function(e, t, r, n) {
		...
		if ("function" != typeof n) return pt.sign({
			header: o,
			payload: e,
			secret: t,
			encoding: u
		});
		n = n && Dr(n), pt.createSign({
			header: o,
			privateKey: t,
			payload: e,
			encoding: u
		...
		try {
			i = Mr(e, function(e, t) {
				...
				var s = i.length / 2,
					...
					c = ue(s),
					u = ue(a),
					d = "30" + ue(s + a + c.length / 2 + u.length / 2 + 2) + "02" + c + i + "02" + u + o;
...
var $r = function(e = {}) {
		return e.appId = e.appid, e.secret = e.appsecret, O(te, e)
	},
	Kr = function(e = {}) {
		return e.appId = e.appid, e.secret = e.appsecret, O(ne, e)
	},
	Gr = function(e = {}) {
		return e.appId = e.appid, O(se, e)
	},
	Qr = function(e = {}) {
		return O(Hr, e)
	};
...
async function Jr({
	...
	const i = Object.keys($).reduce((e, t) => {
		const r = t,
			i = function(e, t) {
	...
	let o;
	const s = {
			dcloud_appid: zr.in(t),
			_id: zr.neq(n._id)
		},
		a = {
			dcloud_appid: zr.exists(!1),
			_id: zr.neq(n._id)
		};
	switch (i.length) {
		case 0:
		...
		case 1:
			o = zr.or([zr.and([i[0], s]), zr.and([i[0], a])]);
			break;
		default:
			o = zr.or([zr.and([zr.or(i), s]), zr.and([zr.or(i), a])])
	}
...
const dn = uniCloud.database();
const ln = uniCloud.database();
const pn = uniCloud.database();
const fn = uniCloud.database();
const mn = uniCloud.database().command;
const hn = uniCloud.database();
var gn = Object.freeze({
	...
	resetPwd: async function({
		...
		return n && (i.password_secret_version = n), A("upRes", await M.doc(e).update(i)), {
			code: 0,
			msg: ""
		}
	},
	...
	updatePwd: async function(e) {
		...
		if (t && t.data && t.data.length > 0) {
			if (0 === this._checkPwd(t.data[0], e.oldPassword).code) {
				...
				return A("upRes", await M.doc(t.data[0]._id).update(i)), {
					code: 0,
					msg: ""
				}
			}
	...
	updateUser: async function(e) {
		...
		return s && (i && (s = s.toLowerCase()), e.username = s), a && (o && (a = a.toLowerCase()), e
			.email = a), A("update -> upRes", await M.doc(t).update(e)), {
			code: 0,
			msg: ""
		}
	},
	...
	_loginExec: async function(e, t = {}) {
		if (e.status === J) return {
			code: 10001
		};
		if (e.status === X) return {
			code: 10006
		};
	...
	getPermissionByRole: async function({
		...
		if ("admin" === e) {
			return {
				code: 0,
				msg: "",
				permission: (await H.limit(1e3).get()).data.map(e => e.permission_id)
			}
		}
	...
	bindRole: async function({
		...
		const n = {};
		return "string" == typeof t && (t = [t]), n.role = r ? t : sn.push(t), await M.doc(e).update(n), {
			code: 0,
			msg: ""
		}
	},
	bindPermission: async function({
		...
		const n = {};
		return "string" == typeof t && (t = [t]), n.permission = r ? t : sn.push(t), await F.where({
			role_id: e
		}).update(n), {
			code: 0,
			msg: ""
	...
	getPermissionList: async function({
		...
		const n = {
			code: 0,
			msg: "",
			permissionList: (await H.skip(t).limit(e).get()).data
		};
		if (r) {
			const {
				total: e
	...
	deletePermission: async function({
		...
		return await H.where({
			permission_id: sn.in(e)
		}).remove(), await F.where({
			permission: sn.elemMatch(sn.in(e))
		}).update({
			permission: sn.pullAll(e)
		}), {
			code: 0,
			msg: ""
		}
	...
	checkToken: async function(e, {
		...
		if (l || p) {
			...
			if (f = t.data[0], f.status === J) return {
				code: 10001
			};
			if (f.status === X) return {
				code: 10006
			};
			let r = f.token;
	...
	_getPermissionListByRoleList: async function(e) {
		...
		if (0 === e.length) return [];
		if (e.includes("admin")) {
			return (await H.limit(500).get()).data.map(e => e.permission_id)
		}
		const t = await F.where({
				role_id: mn.in(e)
			}).get(),
	...
	verifyCode: async function({
		...
		if (A("verifyRecord:", a), a && a.data && a.data.length > 0) {
			const e = a.data[0];
			return A("upRes", await B.doc(e._id).update({
				state: 1
			})), {
				code: 0,
				msg: "验证通过"
...
class wn {
	constructor({
		...
		let n;
		this.pluginConfig = r, this.config = t || this._getConfigContent(), Object.defineProperty(this, "config", {
			get: () => t || this._getConfigContent()
		}), Object.defineProperty(this, "context", {
			get() {
				const t = e || global.__ctx__ || {},
			...
			fallbackLocale: "zh-Hans",
			messages: U
		}), console.warn(n.t("hx-version-warning"))), Object.defineProperty(this, "t", {
			get() {
...
for (const e in gn) wn.prototype[e] = gn[e];
...
wn.prototype.createInstance = vn;
var _n = vn();
module.exports = _n;
